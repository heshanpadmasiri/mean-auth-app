...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_token_interceptor__ = __webpack_require__("../../../../../src/app/services/token.interceptor.ts");
...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_13__components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */]] },
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__services_auth_service__["a" /* AuthService */],
                {
                    ...
                    useClass: __WEBPACK_IMPORTED_MODULE_15__services_token_interceptor__["a" /* TokenInterceptor */],
                    multi: true
                },
...
module.exports = "<div class=\"jumbotron jumbotron-fluid text-center\">\n  <h1>MEAN Authentication App</h1>\n  <p class=\"lead\">\n    Welcome to custom MEAN authentication app built form scratch\n  </p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/login']\">Log in</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Back-end</h3>\n    <p>Used to creat a common rest api</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular CLI</h3>\n    <p>Makes using anuglar much easier</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT tokens</h3>\n    <p>Used to identify and authenticate users</p>\n  </div>\n</div>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(auth, router, flashMessagesService) {
        this.auth = auth;
        this.router = router;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.auth.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessagesService.show("Login successful", {
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(auth, flashMessageServices, router) {
        this.auth = auth;
        this.flashMessageServices = flashMessageServices;
        this.router = router;
    }
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ping = function () {
        var _this = this;
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(validateService, flashMessagesServie, auth, router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.auth.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesServie.show("Successfully registered", { cssClass: 'alert-success', timeOut: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessagesServie.show("Something went wrong", { cssClass: 'alert-danger', timeOut: 3000 });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.isAuthenticated = function () {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_3_angular2_jwt__["tokenNotExpired"])(null, token);
    };
